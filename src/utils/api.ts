...
class ApiClient {
  ...
  async syncPasswords(passwords: any[], lastSyncTimestamp?: string, syncType?: string): Promise<PasswordSyncResponse> {
    return this.request('/passwords', {
      method: 'POST',
      body: JSON.stringify({ passwords, lastSyncTimestamp, syncType }),
    });
  }
